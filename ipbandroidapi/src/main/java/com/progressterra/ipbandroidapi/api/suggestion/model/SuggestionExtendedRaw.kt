...
internal data class SuggestionExtendedRaw(
    ...
    @SerializedName("area_fias_id") val areaFiasId: String?,
    @SerializedName("area_kladr_id") val areaKladrId: String?,
    @SerializedName("block") val block: String?,
    @SerializedName("city") val city: String?,
    @SerializedName("city_district") val cityDistrict: String?,
    @SerializedName("city_district_fias_id") val cityDistrictFiasId: String?,
    @SerializedName("city_district_kladr_id") val cityDistrictKladrId: String?,
    @SerializedName("city_fias_id") val cityFiasId: String?,
    ...
    @SerializedName("house_fias_id") val houseFiasId: String?,
    @SerializedName("house_kladr_id") val houseKladrId: String?,
    @SerializedName("kladr_id") val kladrId: String?,
    @SerializedName("postal_code") val postalCode: String?,
    @SerializedName("region") val region: String?,
    @SerializedName("region_fias_id") val regionFiasId: String?,
    @SerializedName("region_iso_code") val regionKladrId: String?,
    @SerializedName("region_type") val regionType: String?,
    @SerializedName("street") val street: String?,
    @SerializedName("street_fias_id") val streetFiasId: String?,
    @SerializedName("street_kladr_id") val streetKladrId: String?
)